...
"""
Text/HTML cleaning and signature extraction utilities.
Adapted from your original code, modularized.
"""
...
class ImprovedSignatureExtractor:
    ...
    def extract_website_from_text(self, text: str) -> list[str]:
    ...
    # -------- main --------
    def extract_signature(self, raw_text: str, sender_header: str | None = None) -> dict:
